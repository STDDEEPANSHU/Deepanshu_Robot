...
import DeepanshuRobot.modules.sql.global_bans_sql as gban_sql
import DeepanshuRobot.modules.sql.users_sql as user_sql
from DeepanshuRobot import DEV_USERS, OWNER_ID, dispatcher
